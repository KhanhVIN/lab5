...
class TrainerFlockingPart3(Trainer):
...
class TrainerFlockingPart4(Trainer):
        ...
        while epoch < self.nEpochs:
            ...
            while batch < self.nBatches:
                ...
                if (epoch * self.nBatches + batch) % self.validationInterval == 0:
                    ...
                    _, _, est_vels_valid, biased_vels_valid, accels_valid = self.simulator.computeTrajectory_pos(
